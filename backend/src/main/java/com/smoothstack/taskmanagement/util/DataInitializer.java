package com.package com.example.taskmanagement.util;
...
import com.package com.example.taskmanagement.util;
...
}.taskmanagement.repository.TaskRepository;
import com.package com.example.taskmanagement.util;
...
}.taskmanagement.repository.UserRepository;
import org.springframework.boot.CommandLineRunner;
import org.springframework.security.crypto.password.PasswordEncoder;
import org.springframework.stereotype.Component;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        User admin = new User();
        admin.setUsername("admin");
        admin.setEmail("admin@package com.example.taskmanagement.util;
...
public class DataInitializer implements CommandLineRunner {
    ...
    private void createSampleTask(String title, String desc, String status, int priority, User assignee, User creator) {
        ...
        User user = new User();
        user.setUsername("user");
        user.setEmail("user@package com.example.taskmanagement.util;
